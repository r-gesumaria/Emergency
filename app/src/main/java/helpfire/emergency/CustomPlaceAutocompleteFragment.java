...
public class CustomPlaceAutocompleteFragment extends PlaceAutocompleteFragment {
    ...
    private void zzzG() {
        ...
        try {
            Intent var2 = (new PlaceAutocomplete.IntentBuilder(2)).setBoundsBias(this.zzaRk).setFilter(this.zzaRl).zzdB(this.editSearch.getText().toString()).zzbn(1).build(this.getActivity());
